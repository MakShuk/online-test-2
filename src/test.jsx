  ...
  "modules": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "text": "Как доносить информацию до Производителя? Выделите 3 параметра",
          "options": [
        ...
        {
          "id": 2,
          "text": "Как доносить информацию до Администратора? Выделите 3 параметра",
          "options": [
        ...
        {
          "id": 3,
          "text": "Как доносить информацию до Предпринимателя? Выделите 3 параметра",
          "options": [
        ...
        {
          "id": 4,
          "text": "Как доносить информацию до Интегратора? Выделите 3 параметра",
          "options": [
            "Когда он участвует в процессе принятия решений, относитесь к его чувствам и взглядам непредвзято, даже если вы занимаете иную позицию",
            "Дайте ему возможность внести поправки в ваше решение и обогатить его собственными идеями. Никогда не вносите предложения, которые нельзя изменить",
            "Станьте для него источником информации",
